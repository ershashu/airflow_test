...
dag = DAG(
    ...
    params={
        ...
        "query": Param(
            "select \* from mysql.tpcds_partitioned_orc_2.customer limit 100", type="string", description="EzPresto Query "
        ),
...
run_ezpresto_query_via_spark = SparkKubernetesOperator(
    ...
    application_file="spark_ezpresto_user09.yaml",
    do_xcom_push=True,
    dag=dag,
