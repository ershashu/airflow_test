...
dag = DAG(
    ...
    params={
        ...
        "query": Param(
            "select \* from mysql.tpcds_partitioned_orc_2.call_center limit 100", type="string", description="EzPresto Query "
        ),
...
run_ezpresto_query_via_spark = SparkKubernetesOperator(
    ...
    application_file="spark_ezpresto_user07.yaml",
    do_xcom_push=True,
    dag=dag,
