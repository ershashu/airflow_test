...
def execute_query():
    ...
    keycloak_payload = 'username=hpedemo-user03&password=Hpepoc@123&grant_type=password&client_id=ua-grant'
    ...
    ezpresto_payload = json.dumps({"query": "select * from mysql.tpch_partitioned_orc_2.partsupp"})
